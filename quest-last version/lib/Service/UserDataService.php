 ...
 * 
 * Provides centralized access to user data from the ncquest_users table.
 * Legacy quest_user_data table support has been removed after migration.
 * 
 * Key Features:
 * - Unified interface for user data operations
 * - Direct ncquest_users table integration
...
class UserDataService {
    ...
    public function getUserData(string $userId, bool $forceRefresh = false): array {
        ...
        try {
            // Get data from ncquest_users table only
    ...
    public function updateUserData(string $userId, array $data): bool {
        // Legacy table initialization removed
