...
return [
    'routes' => [
        ...
        ['name' => 'taskCompletion#test', 'url' => '/api/test-task-completion', 'verb' => 'GET'],
        ['name' => 'taskCompletion#basicTest', 'url' => '/api/basic-test', 'verb' => 'GET'],
        ['name' => 'taskCompletion#ultraMinimalTest', 'url' => '/api/ultra-test', 'verb' => 'GET'],
        ['name' => 'diagnostic#test', 'url' => '/api/diagnostic-test', 'verb' => 'GET'],
        ['name' => 'diagnostic#postTest', 'url' => '/api/diagnostic-post-test', 'verb' => 'POST'],
        ['name' => 'taskCompletion#testPost', 'url' => '/api/test-post-completion', 'verb' => 'POST'],
        ['name' => 'taskCompletion#completeTaskFromList', 'url' => '/api/complete-quest', 'verb' => 'POST'],
